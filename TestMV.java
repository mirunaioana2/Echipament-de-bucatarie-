...
public class Test {
    public static void main(String[] args) {
        ...
        // afisarea datelor pentru Frigider
        ...
        for (CombinaFrigorifica combina : combineFrigorifice) {
         ...
         // Afișarea obiectelor care îndeplinesc condițiile impuse

        System.out.println("Frigidere care îndeplinesc condițiile:");
        for (Frigider frigider : frigidere) {
            // Condiția 1: Are NoFrost == true
            // Condiția 2: Temperatura maximă < 6°C
            if (frigider.isAreNoFrost() && frigider.getTemperaturaMaxima() < 6.0) {
                System.out.println(frigider);
            }
        }

        System.out.println("\nCombine Frigorifice care îndeplinesc condițiile:");
        for (CombinaFrigorifica combina : combineFrigorifice) {
